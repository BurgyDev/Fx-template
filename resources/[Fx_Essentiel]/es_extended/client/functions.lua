...
function ESX.GetVehicleType(model)
    ...
    return types[vehicleType] or "automobile"
      ...
      function SetData()
        ...
        Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', "~r~FivemXperience~w~ RP~s~ | Discord : https://discord.gg/CptmeXvuBk  ~g~~s~ | ID: "..id.." | ~r~".. #players .." connecté(e)s")
    ...
    Citizen.CreateThread(function()
        ...
        AddTextEntry("PM_PANE_LEAVE", "~r~Se déconnecter de ~p~FivemXperience~w~ RP 😭")
...
AddEventHandler('Boost-Discord:SetPresence', function(data)
	...
	SetDiscordAppId(Config.FivemXperienceIDAPPlication)
