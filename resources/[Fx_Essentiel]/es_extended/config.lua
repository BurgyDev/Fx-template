...
Config.CustomAIPlates            = "FxFivem" -- Custom plates for AI vehicles
...
Config.FivemXperienceIDAPPlication =  1207626396319485952
...
Config.Buttons = { -- Your buttons
    ...
    {index = 0,name = 'Discord',url = 'https://discord.gg/CptmeXvuBk'},

    {index = 1,name = 'Connexion',url = ''}
